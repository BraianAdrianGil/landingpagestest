...
<body>
        ...
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1  gap-6">
                    ...
                    <a href="dontQualify.php "> <button id="btn-3" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">
                            Under 64 </button></a>
    ...
    <footer class="footer mt-12 footer-center p-4 mt-12 mb-2 text-center max-w-6xl mx-auto text-xs">
        ...
        <div class="mt-8">
            <p>Copyright Golden Years Benefits © 2024 - All right reserved
            </p>
        </div>
    </footer>
    ...
    <script>
        ...
        const setZip = () => {
            ...
            newUrl.searchParams.set('ip_zip', "");
            window.history.pushState({
                path: newUrl.href
            }, '', newUrl.href);
        };
